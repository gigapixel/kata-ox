export class OX {
  ...
  checkGame(input) {        
    ...
    for (let pos=0; pos<3; pos++) {
      ...
      winResult = (!winResult  && (rowData[0] === rowData[1] && rowData[0] === rowData[2])) ? rowData[0] : winResult;
      winResult = (!winResult  && (input[0][pos] === input[1][pos] && input[0][pos] === input[2][pos])) ? input[0][pos] : winResult;
  ...
  playOX(input) {
    ...
    return (result && result != ' ') ? 'Winner: ' + result : txtResult;    
  }
}
